...
# In fact, the codes until line 370, are just the codes included in the library layoutlm.data.funsd, we can use these functions directly by importing this library.
# after line 370, we create the torch type dataset for funsd which can be directly called in main.py to train.
...
image = Image.open("PIC-PROJ/data_loading/FUNSD/train/images/0000971160.png")
...
# test annotation
with open('PIC-PROJ/data_loading/FUNSD/train/annotations/0000971160.json') as f:
  data = json.load(f)

for annotation in data['form']:
  print(annotation)

# Use ImageDraw to draw the annotations (rectangles) on the image:
